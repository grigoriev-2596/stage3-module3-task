...
public class Constant {
    ...
    public static final String ENTER_TAG_IDS = "Enter tag ids (example: 1 3 7; can be empty):\n>>";
    public static final String ENTER_TAG_NAMES = "Enter tag names (example: weather politics films)\n>>";

    public static final String ENTER_AUTHOR_ID = "Enter author id:\n>>";
    public static final String ENTER_AUTHOR_NAME = "Enter author name:\n>>";

    public static final String ENTER_NUMBER_OF_OPERATION = "Enter number of operation:\n>>";
